...
public class SubProgramChair implements Serializable {
	 ...
	 * 
	 * @param theSelection 1 if recommend this paper, 2 otherwise.
	 ...
	 * @author Jeremy Wolf
	 * @return myFirstName the first name of this subprogram chair.
	 */
	...
	/**
	 * Getter method for my paper list field.
	 * @author Jeremy Wolf
	 * @return myPaperList the list of paper under this subprogram chair.
	 */
	 ...
	 * @author Jeremy Wolf
	 * @return myLastName the last name of this subprogram chair.
	 */
	 ...
	 * @return myUsers the list of users under this subrogram chair.
	 */
	 ...
	 * @author Jeremy Wolf
	 * @return myID the ID of this subprogram chair.
	 */
	public String getID() {
		return myID;
	}
